	...
	<?php
	  ...
	  header("Access-Control-Allow-Origin: *");
		...
		if($_POST){
			...
			if($res->exists == "true" && $res->user[0]->type == "0"){
	...
	<div id="header-content">
	  ...
	  <nav>
	    ...
	    <ul>
	      ...
	      <li><a href="login.php" style="color:#9f4eb6">Login</a></li>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic">
					<img src="img/pat-doctor.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" method="post" action="logindoc.php">
					...
					<div >
							<a href="signupdoc.php" style="text-decoration:none"><input type=button class="login100-form-btn" style="background:silver;color:darkslategray" value="Create your Account">
							</a>
					</div>
