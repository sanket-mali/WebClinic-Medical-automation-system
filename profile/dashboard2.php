                                ...
                                <div class="list_general">
                                    <ul>
                                        <li>
                                            ...
                                            <p><button type="submit" id="btnview" data-id="hello" data-toggle="modal" data-target="#myModal" class="btn_1 gray view"><i class="fa fa-fw fa-user"></i> View profile</button></p>
                                            <ul class="buttons">
