...
<body>
	...
	if(!isset($_SESSION['loggedIn']) || $_SESSION['loggedIn'] != "yes"  || !isset($_SESSION['doc']) || !isset($_SESSION['doc'])){
                                    ...
                                    <div class="doctor-main-card" style="margin-top:15px;" id="doc<?php echo $x; ?>">
                                      <input type="hidden" name="appid" id="appid<?php echo $x;?>" value="<?php echo $apt['appid']; ?>">
                                        ...
                                        <div class="row doclower" style="padding:0px;">
                                          <div class="operation">
                                            <button type="submit" class="btn btnbook1" id="<?php echo $x;?>" style="font-weight:500px;border-radius:15px 0px 0px 15px;float:left;width:50%" name="approve">Approve</button>
