...
<body>
	...
	<?php
			...
			if($_POST){
			    ...
			    CURLOPT_URL => 'http://localhost/clinic/v3/api/doctor/' . $_POST['uname'],
			    CURLOPT_POST => 1,
...
<header id="myHeader">
  ...
  <div class="container-login100">
    <div class="wrap-login100">
      ...
      <form class="login100-form validate-form" method="post" action="signupdoc.php">
        ...
        <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz" ><!--form validation message-->
          <input class="input100" type="text" name="uname" placeholder="Email" autofocus>
          <span class="symbol-input100">
